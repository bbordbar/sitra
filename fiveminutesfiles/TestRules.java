...
public class TestRules {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Title: " + destinationPublication.getTitle());
			System.out.println("Author(s): " + destinationPublication.getAuthorsList());
			System.out.println("NumberOfPages: " +destinationPublication.getNoOfPages());
